...
#define STRING_CONFIG_H_AUTHOR "(Thore)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_RE_ARM_SF
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 15 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 200, 200, 20 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 400, 400, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 } //my_probe_offset
...
#define XY_PROBE_FEEDRATE (25*60) 
...
#define Y_BED_SIZE 383
#define Z_BED_SIZE 55  - 23 //23 to 55
...
//#define DEBUG_LEVELING_FEATURE 
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 32 // (mm) Default fade height.
  #endif
...
#define HOMING_FEEDRATE_MM_M { (5*60), (5*60), (2*60) }
